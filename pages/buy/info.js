...
const Info = () => {
    ...
    useEffect (()=>{
        axios.get(`http://127.0.0.1:8000/product/${encodeURIComponent(query.id)}/`)
        .then(res=>{
        ...
        <div className="min-h-screen py-2 bg-midNight">
            ...
            <div className="grid grid-cols-2 p-4 m-4 border rounded-xl mt-12 ">
                ...
                <div className="border border-red  rounded-xl">
                    ...
                    <button className="text-black text-xl bg-green my-10 border rounded xl border-transparent transform motion-safe:hover:scale-110 ... mx-40 px-4 py-2">Add to cart</button>
