...
const sell = () => {
  ...
  return (
    <div className="min-h-screen  mx-auto py-2 bg-midNight">
      ...
      <NavBar/>
      <div className="w-1/2 mt-20 mb-20 mx-auto border p-6 rounded-xl   ">
                <form onSubmit = {(e)=>handleSubmit(e)}>
                    <h1 className="text-green text-center text-4xl font-bold">Enlist your product!</h1>
                    <div className="flex flex-col p-3 mt-3">
                    <div className="mb-1">
                    <label for="title" className="text-white text-2xl" >Name:</label>
                    </div>
                    <input type="text" value={title} onChange={(e)=>setTitle(e.target.value)} className=" w-full py-1 px-3 border focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent rounded" placeholder="Title of your product" id="title" name="title"></input>
                    </div>
                    <div className="p-3">
                    <div className="mb-1">
                    <label for="desc" className="text-white text-2xl" >Description:</label>
                    </div>
                    ...
                    <div className="p-3">
                    <div className="mb-1">
                    <label for="price" className="text-white text-2xl" >Price:</label>
                    </div>
                    ...
                    <div className="p-3">
                    <div className="mb-1">
                    <label for="img" className="text-white text-2xl" >Upload image of the product:</label>
                    </div>
